...
import android.smart.home.smarthome.util.SvgPathParser;
...
public class WowSplashView extends View {
    ...
    private String mTitle = "SmartHome";
    ...
    public WowSplashView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundColor(context.getResources().getColor(R.color.startcolor));
