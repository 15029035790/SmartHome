package esptouch.demo_activity;
...
import android.smart.home.smarthome.activity.BaseAppCompatActivity;
import android.smart.home.smarthome.activity.MainActivity;
...
public class EsptouchDemoActivity extends BaseAppCompatActivity implements
		OnClickListener,HeaderLayout.onLeftImageButtonClickListener {
	...
	private TextInputLayout mTilApPassword;

	private TextInputEditText mTieApPassword;

	private SuperButton mBtnConfirm;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_connect_device_esptouch);

		mWifiAdmin = new EspWifiAdminSimple(this);
		mTvApSsid = (TextView) findViewById(R.id.tv_ssid);
		mHeaderLayout = (HeaderLayout) findViewById(R.id.cd_headerLayout);
		initTopBarForLeft(mHeaderLayout,"设备接入",this);
		mTilApPassword = (TextInputLayout) findViewById(R.id.til_password);
		mTieApPassword = (TextInputEditText) mTilApPassword.getEditText();
		mBtnConfirm = (SuperButton) findViewById(R.id.sbt_confirm);
	...
	public void onClick(View v) {
		...
		if (v == mBtnConfirm) {
			...
			String apPassword = mTieApPassword.getText().toString();
